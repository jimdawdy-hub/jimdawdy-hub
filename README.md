...
| Repo | What it does |
|---|---|
| [codeplugger](https://github.com/jimdawdy-hub/codeplugger) | DMR codeplug generator for the Baofeng DM-32UV — CLI + web UI |
| [dmrfill-yaml-fixer](https://github.com/jimdawdy-hub/dmrfill-yaml-fixer) | Repairs broken YAML codeplugs from dmrfill for qdmr/dmrconf (works with any DMR radio) |

---

## Stack

`Linux` `Python` `TypeScript` `Ollama` `ROCm` `RAG` `FFmpeg` `Docker` `Amateur Radio`
